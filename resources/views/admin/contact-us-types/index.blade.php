...
@section('content')
                    ...
                    @foreach($objects as $ob)
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger" onclick="confirmDelete('{{route('admin.contactTypes.delete',$ob->id)}}')" data-toggle="modal" data-target="#delete-model">
    ...
    <div class="modal fade" id="addModel">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header"><h4 class="modal-title">{{__('add_contactTypes')}}</h4></div>
                <form action="{{route('admin.contactTypes.store')}}" method="post" role="form" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="editModel">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header"><h4 class="modal-title">{{__('edit_contactTypes')}}</h4></div>
...
@section('script')
    <script>
        function edit(ob){
            $('#editForm')      .attr("action","{{route('admin.contactTypes.update','obId')}}".replace('obId',ob.id));
