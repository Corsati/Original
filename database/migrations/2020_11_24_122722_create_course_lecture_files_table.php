...
class CreateCourseLectureFilesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('course_lecture_files', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->string('file');
    ...
    {
        Schema::dropIfExists('course_lecture_files');
    }
}
